...
export const getEvidence = asyncHandler(async (req, res, next) => {
  ...
  // Todos os usuários podem acessar qualquer evidência
...
export const createEvidence = asyncHandler(async (req, res, next) => {
  ...
  // Remover a verificação de propriedade do caso
  // Todos os usuários autorizados podem adicionar evidências a qualquer caso
  ...
  if (req.body.type === "image") {
    ...
    if (!req.body.cloudinary || !req.body.cloudinary.url) {
      return next(
        new ErrorResponse(
          `Please upload an image first and provide the Cloudinary URL`,
          400
        )
      );
    }
...
export const updateEvidence = asyncHandler(async (req, res, next) => {
  ...
  // Remover a verificação de propriedade do caso
  // Todos os usuários autorizados podem atualizar qualquer evidência
...
export const deleteEvidence = asyncHandler(async (req, res, next) => {
  ...
  // Remover a verificação de propriedade do caso
  // Todos os usuários autorizados podem excluir qualquer evidência
...
export const getCaseEvidence = asyncHandler(async (req, res, next) => {
  ...
  // Remover a verificação de propriedade do caso
  // Todos os usuários podem acessar evidências de qualquer caso
