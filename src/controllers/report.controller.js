...
export const getReport = asyncHandler(async (req, res, next) => {
  ...
  // Todos os usuários podem acessar qualquer relatório
...
export const createReport = asyncHandler(async (req, res, next) => {
  ...
  // Remover a verificação de propriedade do caso
  // Todos os usuários autorizados podem criar relatórios para qualquer caso
  ...
  console.log(
    `Case ${forensicCase._id} status updated to "finalizado" after report creation`
  );
...
export const updateReport = asyncHandler(async (req, res, next) => {
  ...
  // Remover a verificação de propriedade do caso
  // Todos os usuários autorizados podem atualizar qualquer relatório
...
export const deleteReport = asyncHandler(async (req, res, next) => {
  ...
  // Remover a verificação de propriedade do caso
  // Todos os usuários autorizados podem excluir qualquer relatório
...
export const getCaseReports = asyncHandler(async (req, res, next) => {
  ...
  // Remover a verificação de propriedade do caso
  // Todos os usuários podem acessar relatórios de qualquer caso
...
export const exportReportPDF = asyncHandler(async (req, res, next) => {
  ...
  // Remover a verificação de propriedade do caso
  // Todos os usuários podem exportar qualquer relatório como PDF
...
export const signReport = asyncHandler(async (req, res, next) => {
  ...
  // Remover a verificação de propriedade do caso
  // Todos os usuários autorizados podem assinar qualquer relatório
  ...
  if (report.status !== "finalizado") {
    const error = new Error(
      `Report must be in 'finalizado' status to be signed`
    );
    error.statusCode = 400;
    return next(error);
  }
